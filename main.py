...
당신은 INTJ, 치밀한 전략가입니다.  
당신과 닮은 수학자는 <b>아이작 뉴턴</b>! 미적분학을 창시하고, 우주의 법칙을 수식으로 표현한 위대한 사상가죠.  
...
당신과 닮은 수학자는 <b>쿠르트 프리드리히 괴델</b>! ‘수학은 완벽하다’는 믿음을 뒤엎은 불완전성 정리를 제시했죠.  
...
당신과 닮은 수학자는 <b>존 폰 노이만</b>! 게임이론, 컴퓨터 구조 등 시대를 앞선 아이디어로 수학계를 뒤흔들었죠.  
...
당신과 닮은 수학자는 <b>르네 데카르트</b>! 좌표평면을 창시하고 기하학과 대수학을 연결한 구조 설계자죠.  
...
당신과 닮은 수학자는 <b>블레즈 파스칼</b>! 삼각형을 통해 수를, ‘내기’를 통해 철학을 설명한 통찰력의 소유자죠.  
...
당신과 닮은 수학자는 <b>에바리스트 갈루아</b>! 20세에 요절했지만 ‘갈루아 이론’으로 현대 수학의 토대를 세운 천재였죠.  
...
당신과 닮은 수학자는 <b>피타고라스</b>! 모든 것을 수로 설명하려 했던 철학적 수학자죠.  
...
당신과 닮은 수학자는 <b>페터 구스타프 르죈 디리클레</b>! 수학의 함수 개념을 명확히 하고, 후학 양성에도 힘쓴 교육자였습니다.  
...
당신과 닮은 수학자는 <b>카를 프리드리히 가우스</b>! '수학의 왕'이라 불리며, 꼼꼼하게 이론을 쌓아 올렸죠.  
...
당신과 닮은 수학자는 <b>소피 제르맹</b>! 여성이라는 이유로 수학을 금지당했지만, 끝까지 논문을 발표한 의지의 상징입니다.  
당신처럼 조용하지만 깊이 있는 열정을 가진 사람은 수학계에서도 귀중한 존재예요.  
포기하지 않는 태도, 그것이 곧 수학자의 자질이랍니다.""",

    "ESTJ": """<b>ESTJ – 체계적 실천가</b>  
당신은 ESTJ, 구조와 질서를 중시하는 실행가입니다.  
당신과 닮은 수학자는 <b>데이비드 힐베르트</b>! 수학을 체계화하고 23개의 문제를 제시하며 후세에 과제를 남겼죠.  
...
당신과 닮은 수학자는 <b>유클리드</b>! ‘기하학의 아버지’로서 후대에게 수학을 설명하고 가르친 대표적인 교육자죠.  
...
당신과 닮은 수학자는 <b>레온하르트 오일러</b>! 지금까지도 수많은 수학 기호와 공식을 만든 다작의 천재죠.  
...
당신과 닮은 수학자는 <b>피에르 드 페르마</b>! ‘페르마의 마지막 정리’로 수백 년간 수학계를 골칫거리로 남긴 고독한 천재죠.  
자신만의 방식으로 문제를 탐구한 그는, ISFP처럼 자유로운 영혼이었습니다.  
당신만의 시선으로 수학을 바라보세요.""",

    "ESTP": """<b>ESTP – 즉흥적 해결사</b>  
당신은 ESTP, 민첩하고 대담하게 문제를 푸는 현실주의자입니다.  
당신과 닮은 수학자는 <b>조제프 푸리에</b>! 열전도 방정식을 풀다가 ‘푸리에 급수’라는 혁신을 만들어낸 인물이죠.  
...
당신과 닮은 수학자는 <b>아르키메데스</b>! 욕조 속에서 “유레카!”를 외친 것으로 유명한 고대의 천재죠.  
